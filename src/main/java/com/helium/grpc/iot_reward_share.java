...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      iot_reward_share.class.getName());
  }
  // Use iot_reward_share.newBuilder() to construct.
  private iot_reward_share(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public enum RewardCase
    ...
    public static RewardCase forNumber(int value) {
      switch (value) {
        ...
        case 5: return UNALLOCATED_REWARD;
  ...
  public static final int UNALLOCATED_REWARD_FIELD_NUMBER = 5;
  /**
   ...
   */
  @java.lang.Override
  public com.helium.grpc.unallocated_reward getUnallocatedReward() {
    if (rewardCase_ == 5) {
       return (com.helium.grpc.unallocated_reward) reward_;
    }
   ...
   */
  @java.lang.Override
  public com.helium.grpc.unallocated_rewardOrBuilder getUnallocatedRewardOrBuilder() {
    if (rewardCase_ == 5) {
       return (com.helium.grpc.unallocated_reward) reward_;
    }
    return com.helium.grpc.unallocated_reward.getDefaultInstance();
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (rewardCase_ == 5) {
      output.writeMessage(5, (com.helium.grpc.unallocated_reward) reward_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (rewardCase_ == 5) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(5, (com.helium.grpc.unallocated_reward) reward_);
    }
  ...
  public static final class Builder extends
    ...
    private com.google.protobuf.SingleFieldBuilder<
      ...
      if (operationalRewardBuilder_ == null) {
        ...
        operationalRewardBuilder_ = new com.google.protobuf.SingleFieldBuilder<
            com.helium.grpc.operational_reward, com.helium.grpc.operational_reward.Builder, com.helium.grpc.operational_rewardOrBuilder>(
    ...
    private com.google.protobuf.SingleFieldBuilder<
        com.helium.grpc.unallocated_reward, com.helium.grpc.unallocated_reward.Builder, com.helium.grpc.unallocated_rewardOrBuilder> unallocatedRewardBuilder_;
    /**
     * <code>.helium.poc_lora.unallocated_reward unallocated_reward = 5;</code>
     * @return Whether the unallocatedReward field is set.
     */
     ...
     * <code>.helium.poc_lora.unallocated_reward unallocated_reward = 5;</code>
     */
    public Builder setUnallocatedReward(com.helium.grpc.unallocated_reward value) {
      if (unallocatedRewardBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setUnallocatedReward(
        com.helium.grpc.unallocated_reward.Builder builderForValue) {
      if (unallocatedRewardBuilder_ == null) {
        reward_ = builderForValue.build();
        onChanged();
      } else {
     ...
     * <code>.helium.poc_lora.unallocated_reward unallocated_reward = 5;</code>
     */
    public Builder mergeUnallocatedReward(com.helium.grpc.unallocated_reward value) {
      if (unallocatedRewardBuilder_ == null) {
        if (rewardCase_ == 5 &&
            reward_ != com.helium.grpc.unallocated_reward.getDefaultInstance()) {
          reward_ = com.helium.grpc.unallocated_reward.newBuilder((com.helium.grpc.unallocated_reward) reward_)
              .mergeFrom(value).buildPartial();
        } else {
          reward_ = value;
        }
     ...
     * <code>.helium.poc_lora.unallocated_reward unallocated_reward = 5;</code>
     */
    public com.helium.grpc.unallocated_reward.Builder getUnallocatedRewardBuilder() {
    ...
    @java.lang.Override
    public com.helium.grpc.unallocated_rewardOrBuilder getUnallocatedRewardOrBuilder() {
      if ((rewardCase_ == 5) && (unallocatedRewardBuilder_ != null)) {
     ...
     */
    private com.google.protobuf.SingleFieldBuilder<
        com.helium.grpc.unallocated_reward, com.helium.grpc.unallocated_reward.Builder, com.helium.grpc.unallocated_rewardOrBuilder> 
      ...
      if (unallocatedRewardBuilder_ == null) {
        ...
        unallocatedRewardBuilder_ = new com.google.protobuf.SingleFieldBuilder<
            com.helium.grpc.unallocated_reward, com.helium.grpc.unallocated_reward.Builder, com.helium.grpc.unallocated_rewardOrBuilder>(
                (com.helium.grpc.unallocated_reward) reward_,
                getParentForChildren(),
                isClean());
        reward_ = null;
      }
