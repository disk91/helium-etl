...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return PocLoRa.internal_static_helium_poc_lora_lora_witness_ingest_report_v1_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return PocLoRa.internal_static_helium_poc_lora_lora_witness_ingest_report_v1_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            lora_witness_ingest_report_v1.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof lora_witness_ingest_report_v1)) {
      return super.equals(obj);
    }
    lora_witness_ingest_report_v1 other = (lora_witness_ingest_report_v1) obj;
  ...
  public static lora_witness_ingest_report_v1 parseFrom(
  ...
  public static lora_witness_ingest_report_v1 parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static lora_witness_ingest_report_v1 parseFrom(
  ...
  public static lora_witness_ingest_report_v1 parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static lora_witness_ingest_report_v1 parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static lora_witness_ingest_report_v1 parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(lora_witness_ingest_report_v1 prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public lora_witness_ingest_report_v1 getDefaultInstanceForType() {
      return lora_witness_ingest_report_v1.getDefaultInstance();
    }

    @Override
    public lora_witness_ingest_report_v1 build() {
      lora_witness_ingest_report_v1 result = buildPartial();
    ...
    @Override
    public lora_witness_ingest_report_v1 buildPartial() {
      lora_witness_ingest_report_v1 result = new lora_witness_ingest_report_v1(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(lora_witness_ingest_report_v1 result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof lora_witness_ingest_report_v1) {
        return mergeFrom((lora_witness_ingest_report_v1)other);
      } else {
    ...
    public Builder mergeFrom(lora_witness_ingest_report_v1 other) {
      if (other == lora_witness_ingest_report_v1.getDefaultInstance()) return this;
  ...
  private static final lora_witness_ingest_report_v1 DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new lora_witness_ingest_report_v1();
  }

  public static lora_witness_ingest_report_v1 getDefaultInstance() {
