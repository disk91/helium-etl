...
public interface cell_heartbeat_ingest_report_v1OrBuilder extends
    // @@protoc_insertion_point(interface_extends:helium.poc_mobile.cell_heartbeat_ingest_report_v1)
   ...
   * @return The report.
   */
  com.helium.grpc.mobile.cell_heartbeat_req_v1 getReport();
  /**
   * <code>.helium.poc_mobile.cell_heartbeat_req_v1 report = 2;</code>
   */
  com.helium.grpc.mobile.cell_heartbeat_req_v1OrBuilder getReportOrBuilder();
}
